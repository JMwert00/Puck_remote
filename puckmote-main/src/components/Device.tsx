...
//1 Define an array to store saved functions
let savedFunctions: IFunction[] = [];

// Function to save the IFunction object and create a button for it
function saveAndCreateButton(fn: IFunction) {
  savedFunctions.push(fn); // Save the function
  createButtonForFunction(fn); // Create a button for the function
  // Optionally, you can save the functions to localStorage or any other storage mechanism here
}

// Function to create a button in HTML for a saved function
function createButtonForFunction(fn: IFunction) {
  const newButton = document.createElement("button");
  newButton.innerHTML = `Function: ${fn.functionname}, Device: ${fn.device}`;
